<x-main-layout>
    ...
    <section id="available-packages" class="section-full-width py-16 bg-green-50">
        <div class="section-content-contained">
            <div class="text-center mb-12">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Book Moving Service</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition flex flex-col">
                    ...
                    <p class="text-gray-600 text-sm mb-4 flex-grow">{{ $service->short_description ?? 'Professional moving service.' }}</p>
                    <div class="flex items-end justify-between mt-4">
                        <div>
                            <span class="text-2xl font-bold text-emerald-600">${{ $service->price }}</span>
                        </div>
                        <a href="{{ route('bookings.create', ['service_id' => $service->id]) }}" class="px-6 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-bold rounded-lg hover:from-green-700 hover:to-emerald-700 transition">
                            Book Now
                        </a>
                    </div>
                </div>
            ...
            <div class="text-center py-8 bg-white rounded-xl shadow border border-gray-100">
                ...
                <a href="tel:+18001234567" class="inline-block mt-4 px-6 py-3 bg-emerald-600 text-white font-bold rounded-lg">Call Us</a>
            </div>
            @endif
        </div>
    </section>
