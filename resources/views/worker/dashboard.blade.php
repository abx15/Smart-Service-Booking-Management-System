<x-worker-layout>
        ...
        <div class="bg-gradient-to-r from-teal-600 to-emerald-600 rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl">
            ...
            <div class="relative z-10">
                ...
                <p class="text-teal-100 text-lg">
                    Manage your assigned services and track your earnings
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 card-hover">
            ...
            <h3 class="text-3xl font-black text-gray-900">{{ $stats['total_bookings'] }}</h3>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 card-hover">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs font-bold bg-green-100 text-green-700 px-2 py-1 rounded-full uppercase tracking-wide">Done</span>
            </div>
            <h3 class="text-3xl font-black text-gray-900">{{ $stats['completed_bookings'] }}</h3>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 card-hover">
            ...
            <h3 class="text-3xl font-black text-gray-900">{{ $stats['pending_bookings'] }}</h3>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 card-hover">
            ...
            <h3 class="text-3xl font-black text-gray-900">${{ number_format($stats['total_earnings'], 2) }}</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <a href="{{ route('worker.bookings') }}" class="group bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-blue-500 transition-all duration-300">
            ...
            <p class="text-gray-500 text-sm">Manage your service bookings</p>
        </a>

        <a href="{{ route('worker.earnings') }}" class="group bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-green-500 transition-all duration-300">
            ...
            <h3 class="text-lg font-bold text-gray-900 mb-2">View Earnings</h3>
            <p class="text-gray-500 text-sm">Track your earnings</p>
        </a>

        <a href="{{ route('worker.profile') }}" class="group bg-white p-6 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl hover:border-purple-500 transition-all duration-300">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden mb-12">
        <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
            ...
            <a href="{{ route('worker.bookings') }}" class="text-primary text-sm font-semibold hover:text-primary-dark transition-colors flex items-center gap-1">
                View All
            ...
            <table class="w-full text-left text-sm text-gray-600">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4">
                            <div class="font-bold text-gray-900">{{ $booking->service->name ?? 'N/A' }}</div>
                        </td>
